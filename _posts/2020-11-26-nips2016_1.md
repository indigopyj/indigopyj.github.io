---
layout: post
title: NIPS 2016 &58; Generative Adversarial Networks 논문 요약 - (1)
...
$\prod _{i=1}^m\ p_{model}\left(x^{\left(i\right)};\ \theta \right)$
...
$\min _{ }^{ }D_{KL}\left(p_{data}\ \parallel \ p_{model}\right)\ \ne \ \min _{ }^{ }D_{KL}\left(\ p_{model}\ \parallel \ p_{data}\right)$
