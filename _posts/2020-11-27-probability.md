...
\begin{align*} P(x_i) = \frac{1}{k} \end{align*}
...
\begin{align*} \forall x \in X, P(x) = \sum _{y} P(x,y) \\
p(x) = \int p(x,y)dy \end{align*}
...
\begin{align*} P(y \ver x) = \frac{P(y,x)}{P(x)} \end{align*}
